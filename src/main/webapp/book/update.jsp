...
<script type="text/javascript">
	...
	$(function(){
		//选中下拉框
		$("option[value='${bookInfo.bookCategoryId}']").prop("selected",true);
		//条形码非空验证和全数字,固定长度验证,失去焦点验证
		$("#bookBarCode").bind("keyup",function(){
			validateTextArea("bookBarCode", "bookBarCode_td", 18);
		});
		...
		$("#bookISBN").bind("keyup",function(){
			validateTextArea("bookISBN", "bookISBN_td", 18);
		});
...
<form action="book/update.do" method="post" id="bookForm">
	...
	<tr>
		<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				class="table_right">
				<tr>
					<td><font style="font-size: 12px;"><strong>修改图书(带<span class="star">*</span>为必填项)</strong></font>
					</td>
							...
							<tr>
								<td align="center">
									<table border="0" cellpadding="0" cellspacing="0"
										...
										<input type="hidden" name="bookBarCode" value="${bookInfo.bookBarCode }"/>
											...
											<tr>
												...
												<td class="box_table_odd"><span class="in"> <input
														type="text" id="bookISBN" name="bookISBN" value="${bookInfo.bookISBN }"/> <span class="star">*</span>
											...
											<tr>
												...
												<td class="box_table_odd"><span class="in"> <input
														type="text" id="bookTitle" name="bookTitle" value="${bookInfo.bookTitle }"/> <span class="star">*</span>
												</span><span id="bookTitle_td"></span></td>
											</tr>											
											<tr>
												<td class="box_table_even">图书的作者：</td>
												<td class="box_table_odd"><span class="in"> <input
														type="text" id="bookAuthor" name="bookAuthor" value="${bookInfo.bookAuthor }"/> <span class="star">*</span>
												</span><span id="bookAuthor_td"></span></td>
											</tr>											
											<tr>
												<td class="box_table_even">图书的出版社：</td>
												<td class="box_table_odd"><span class="in"> <input
														type="text" id="bookPress" name="bookPress" value="${bookInfo.bookPress }"/> <span class="star">*</span>
												</span><span id="bookPress_td"></span></td>
											</tr>											
											<tr>
												<td class="box_table_even">图书的出版时间：</td>
												<td class="box_table_odd"><span class="in"> <input
														type="text" id="bookPublish" name="bookPublish" class="time" value='<fmt:formatDate value="${bookInfo.bookPublish }"/>'/> <span class="star">*</span>
												</span><span id="bookPublish_td"></span></td>
											</tr>											
											<tr>
												<td class="box_table_even">图书的印刷次数：</td>
												<td class="box_table_odd"><span class="in"> <input
														type="text" id="bookPrintCount" name="bookPrintCount" value="${bookInfo.bookPrintCount }"/> <span class="star">*</span>
												</span><span id="bookPrintCount_td"></span></td>
											</tr>											
											<tr>
												<td class="box_table_even">图书的备注：</td>
												<td class="box_table_odd"><span class="in"> <textarea
														cols="10" rows="2" id="bookComment" name="bookComment"> ${bookInfo.bookComment }</textarea> 
