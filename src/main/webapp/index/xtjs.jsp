...
<body>
	<div class="body">
		...
		<div style="padding-left: 50px;">
			本套系统面向四种用户：<br>
			1.游客：游客可以直接点击游客来跳转到响应页面，但是游客只能在系统中查询图书信息，不能进行其他的操作。<br>
			2.在馆注册使用的读者：此类用户可以点击登录按钮，图书卡卡号作为登录用户名，填入密码，即可以登录到系统内部来进行响应的操作。<br>此类用户可以知道馆内拥有的图书类别和查询对应想查看的图书在馆内的状态，还可以对自己的图书卡进行在线挂失。并且可以修改自己的账号密码。<br>
			3.馆内图书借阅员：馆内图书借阅员可以通过点击登录按钮，通过填入馆内管理人员分配的用户名和密码进行的登录。图书借阅员的工作，对读者进行借书和还书的登记操作。<br>
			4.馆内管理人员：馆内管理人员可以通过点击登录按钮，通过系统指定的用户名，和自己指定的密码，来登录到系统后台来进行馆内相关事项的维护。<br>
		</div>
	</div>
</body>
</html>
