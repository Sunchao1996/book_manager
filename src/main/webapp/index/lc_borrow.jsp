...
<body>
	<div class="body">
		...
		<div style="padding-left: 50px;">
			1.读者点击游客按钮，可以查看想要借阅的图书------------><br>
			2.未注册本馆合法用户的读者，需要去馆内开通一张图书卡之后方可执行借阅步骤【已经注册的用户可以忽略此步骤】------------><br>
			3.找到想要借阅的图书之后，读者可以查看可以借阅数量还有多少，之后根据情况去图书馆借阅------------><br>
			4.出示图书证去图书借阅员处登记借阅信息------------><br> 5.借书登记完成。<br>
		</div>
	</div>
</body>
</html>
