			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<script type="text/javascript">
							var zNodes2 =[
							    {id : "21",name:"查看借阅信息",open:true,url:"${pageContext.request.contextPath}/back/index.do",target : "navTab"}							    
							];
							$(document).ready(function(){
					...
					<div class="accordionContent">
						<script type="text/javascript">
							var zNodes4 =[
								{id : "41",name : "图书证在线挂失",open:true,url:"${pageContext.request.contextPath}/book_card/updateIndex.do",target : "navTab"},
